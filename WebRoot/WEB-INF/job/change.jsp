...
<form name="form" id="form" method="post" action="select">
  <tr>
    <td height="50" colspan="5" align="center" class="title" >职位修改</td>
  </tr>
<%
...
%>
  <tr>
    <td height="50" colspan="5" align="center" class="advise" >没有职位信息</td>
  </tr>
  <tr align="right">
...
%>
  <tr>
    ...
    <td height="80" align="center">请选择要修改的职位名称:</td>
...
<form name="form1" id="form1" method="post" action="change" onsubmit="return dep()">
 <tr>
   <td width="150" rowspan="4" align="center">&nbsp;</td>
    <td width="200" height="80" align="center">职位名称:</td>
