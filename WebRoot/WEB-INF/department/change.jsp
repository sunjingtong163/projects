...
<form name="form" id="form" method="post" action="select">
  <tr>
    <td height="50" colspan="5" align="center" class="title" >部门修改</td>
  </tr>
<%
...
%>
  <tr>
    <td height="50" colspan="5" align="center" class="advise" >没有部门信息</td>
  </tr>
  <tr align="right">
	<td height="50" colspan="5"><span class="return" onclick="javascript:document.location='department.htm';"><img src="../image/more.gif" width="30" height="9" />返回</span>&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </tr>
<%
	}else{
%>
  <tr>
    ...
    <td height="80" align="center">请选择要修改的部门名称:</td>
...
<form name="form1" id="form1" method="post" action="change" onsubmit="return dep()">
 <tr>
  ...
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;
    <input type="button" name="Submit2" value="返回" onclick="javascript:document.location='department.htm';"/></td>
    </tr>
<% 
			}
		}
