...
<form name="form" id="form" method="post" action="del">
  <tr>
    <td height="50" colspan="5" align="center" class="title" >部门删除</td>
  </tr>
<%
...
%>
  <tr>
    <td height="50" colspan="4" align="center" class="advise" >没有部门信息</td>
  </tr>
  <tr align="right">
...
%>
  <tr>
    ...
    <td height="50" colspan="2" class="advise" >注意：请首先删除属于此部门的所有员工信息</td>
    <td height="50" align="center" class="advise" >&nbsp;</td>
  </tr>
  <tr>
    <td width="150" align="center">&nbsp;</td>
    <td width="210" height="80" align="center">请选择要删除的部门名称:</td>
