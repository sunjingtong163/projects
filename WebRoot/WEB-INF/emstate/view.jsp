...
<table width="780" height="480" cellpadding="0" cellspacing="0">
  <tr>
    <td height="50" colspan="3" align="center" class="title" >员工状态信息一览表</td>
  </tr>
  <tr align="center" class="column">
    <td width="120" height="30">员工状态序号</td>
    <td height="30">员工状态名称</td>
...
%>
  <tr align="center">
    <td height="30" colspan="3" class="advise">没有添加员工状态</td>
  </tr>
  <%
}else{
