...
<form name="form1" id="form1" method="post" action="add" onsubmit="return affice()">
  <tr>
    <td height="50" colspan="4" align="center" class="title" >公告发布</td>
  </tr>
  <tr>
    <td width="165" rowspan="4">&nbsp;</td>
    <td width="152" height="80" align="center">公告标题:</td>
    <td width="293" align="center"><input name="title" type="text" size="40" maxlength="40" /></td>
    <td width="168" rowspan="4">&nbsp;</td>
  </tr>
  <tr>
    <td height="140" align="center">具体公告:</td>
    <td align="center"><textarea name="content" cols="40" rows="10"></textarea></td>
  </tr>
  <tr>
    <td height="80" colspan="2" align="center"><input type="submit" name="Submit" value="发布" />
      &nbsp;&nbsp;&nbsp;
      <input type="button" name="Submit2" value="返回" onclick="javascript:document.location='affice.htm';"/></td>
  </tr>
  <tr>
